...
#note: just changed the name from DDIMS to V_DDIMS to avoid conflicts
...
class V_DDIMSchedulerOutput(BaseOutput):
    """
...
class V_DDIMScheduler(SchedulerMixin, ConfigMixin):
    """
    ...
    def step(
    ...
    ) -> Union[V_DDIMSchedulerOutput, Tuple]:
        """
        ...
        return V_DDIMSchedulerOutput(prev_sample=prev_sample, pred_original_sample=pred_original_sample)
